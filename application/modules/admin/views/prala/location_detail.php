...
if(is_root() || is_admin() || is_editor() || (@$_GET['reg_id'] == $user['username']))
{
	...
	<div class="container-fluid">
		<div class="row">
			<?php 
			if(!empty($prala_location['location']['id']))
			{
				for($i=1;$i<13;$i++)
				{
				...
				msg('anda belum memiliki form location, silahkan klik tombol buat di bawah ini', 'warning');
				?>
				<a href="" class="btn btn-sm -btn-success"><i class="fa fa-pencil-alt"></i> Buat</a>
				<?php
			}
			?>
		</div>
